...
def _recommended_email_prompt(lead: dict) -> str:
    ...
    return (
        ...
        "产品坚持使用VICTREX™ PEEK等国际头部材料粒子生产，不使用回收料；具备有竞争力的价格优势。邮件可自然体现这些优势，但不得编造合作案例、认证、库存、价格数字、联系方式或客户需求。结尾必须附上官网网址 https://www.jutaiplas.com/、联系邮箱 inquiry@jutaipolymer.com 和 WhatsApp：+86 139 1359 5272（https://wa.me/8613913595272）。只可依据输入资料提及客户的行业、产品、材料或需求。"
